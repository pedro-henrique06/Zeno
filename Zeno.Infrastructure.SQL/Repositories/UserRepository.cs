...
public class UserRepository : IUserRepository
{
    ...
    {
        const string sql = @"SELECT Id, Name, Email, PasswordHash, CreatedAt FROM Users WHERE Id = @Id";
    ...
    public async Task<User> CreateAsync(User user)
    {
        ...
        await _context.Connection.ExecuteAsync(sql, new { user.Id, user.Name, user.Email, user.PasswordHash, user.CreatedAt });
        return user;
    }
}
